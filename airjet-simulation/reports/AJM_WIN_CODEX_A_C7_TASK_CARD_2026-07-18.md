...
ACCEPTANCE=4 inlet zones;1 outlet;972 throat faces;1 heat wall;12 membrane-top;12 membrane-bottom;complete 1076-face coverage;10 canonical boundary zones;one connected main fluid zone;correct full-product bbox;Student guards;mesh integrity and quality;real mesh hash;solver mode NOT_ENTERED on failure
...
- Consumer report preserved boundary evidence (4 inlet zones, 1 outlet, 972 throat hits, 1076 imported face zones, throat local sizing) but `volume_mesh=false`, `solver_mode=NOT_ENTERED`, `p1_p6_gates=NOT_RUN`, and `formal_006_completion=false`.
