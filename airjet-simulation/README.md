...
- `windows-prompts/AJM_WIN_V02_PARASOLID_TOPOLOGY_OBSERVER_006.md`：下一次唯一允许的诊断入口；在同一 MCP 进程运行 producer→native-to-x_t converter→Mechanical observer。当前只完成 Mac 静态审计，等待 Windows terminal，不代表路线、mesh 或 P1 PASS。
