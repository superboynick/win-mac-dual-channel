...
- 顶板进气、顶腔、底腔、孔板和冲击通道；
- 结构共振与顶腔声学共振；
- 4–10 mm 广义执行片范围、6–8 mm 优选范围；20–25 kHz 只对应 8 mm 例；
- 10–60 μm 位移；
- 顶腔 200–300 μm；
- 孔宽 200–300 μm、专利孔间隔 `s` 400–600 μm 优选范围；`s` 的中心距/边距图义仍需确认；
- 开孔率 8–12%；
- 冲击间隙 200–300 μm；
- 至少 30 m/s 喷速；部分实施例为至少 45/60 m/s，不存在已公开的 60 m/s 上限；
- 多 cell、共享板和反相驱动实施例。
