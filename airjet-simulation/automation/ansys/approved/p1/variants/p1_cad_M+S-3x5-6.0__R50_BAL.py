# P1 CAD SpaceClaim Script - Variant M+S-3x5-6.0__R50_BALANCED
...
report = {"status": "FAIL_DIRECT", "variant": "M+S-3x5-6.0__R50_BALANCED"}
...
try:
    ...
    # Save
    native = os.path.join(job_dir, "M+S-3x5-6.0__R50_BALANCED.scdocx")
    step = os.path.join(job_dir, "M+S-3x5-6.0__R50_BALANCED.step")
...
with open(os.path.join(job_dir, "M+S-3x5-6.0__R50_BALANCED_report.json"), "w") as f:
