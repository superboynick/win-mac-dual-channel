# P1 CAD SpaceClaim Script - Variant M-3x4-7.0__R50_ORIFICE_EDGE_GAP
...
report = {"status": "FAIL_DIRECT", "variant": "M-3x4-7.0__R50_ORIFICE_EDGE_GAP"}
...
try:
    ...
    # Save
    native = os.path.join(job_dir, "M-3x4-7.0__R50_ORIFICE_EDGE_GAP.scdocx")
    step = os.path.join(job_dir, "M-3x4-7.0__R50_ORIFICE_EDGE_GAP.step")
...
with open(os.path.join(job_dir, "M-3x4-7.0__R50_ORIFICE_EDGE_GAP_report.json"), "w") as f:
