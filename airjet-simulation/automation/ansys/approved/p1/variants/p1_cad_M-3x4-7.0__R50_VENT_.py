# P1 CAD SpaceClaim Script - Variant M-3x4-7.0__R50_VENT_UPPER
...
report = {"status": "FAIL_DIRECT", "variant": "M-3x4-7.0__R50_VENT_UPPER"}
...
try:
    ...
    # Save
    native = os.path.join(job_dir, "M-3x4-7.0__R50_VENT_UPPER.scdocx")
    step = os.path.join(job_dir, "M-3x4-7.0__R50_VENT_UPPER.step")
...
with open(os.path.join(job_dir, "M-3x4-7.0__R50_VENT_UPPER_report.json"), "w") as f:
