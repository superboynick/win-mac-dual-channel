# P1 CAD SpaceClaim Script - Variant M-3x4-7.0__R50_BALANCED
...
report = {"status": "FAIL_DIRECT", "variant": "M-3x4-7.0__R50_BALANCED"}
...
try:
    ...
    # Save
    native = os.path.join(job_dir, "M-3x4-7.0__R50_BALANCED.scdocx")
    step = os.path.join(job_dir, "M-3x4-7.0__R50_BALANCED.step")
...
with open(os.path.join(job_dir, "M-3x4-7.0__R50_BALANCED_report.json"), "w") as f:
