# P1 CAD SpaceClaim Script - Variant M-3x4-7.0__R50_EXHAUST_HALF_TAPER
...
report = {"status": "FAIL_DIRECT", "variant": "M-3x4-7.0__R50_EXHAUST_HALF_TAPER"}
...
try:
    ...
    # Save
    native = os.path.join(job_dir, "M-3x4-7.0__R50_EXHAUST_HALF_TAPER.scdocx")
    step = os.path.join(job_dir, "M-3x4-7.0__R50_EXHAUST_HALF_TAPER.step")
...
with open(os.path.join(job_dir, "M-3x4-7.0__R50_EXHAUST_HALF_TAPER_report.json"), "w") as f:
