# P1 CAD SpaceClaim Script - Variant L-2x4-8.0__R50_BALANCED
...
report = {"status": "FAIL_DIRECT", "variant": "L-2x4-8.0__R50_BALANCED"}
...
try:
    ...
    # Save
    native = os.path.join(job_dir, "L-2x4-8.0__R50_BALANCED.scdocx")
    step = os.path.join(job_dir, "L-2x4-8.0__R50_BALANCED.step")
...
with open(os.path.join(job_dir, "L-2x4-8.0__R50_BALANCED_report.json"), "w") as f:
