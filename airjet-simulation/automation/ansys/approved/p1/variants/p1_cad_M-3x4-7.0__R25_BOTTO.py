# P1 CAD SpaceClaim Script - Variant M-3x4-7.0__R25_BOTTOM_HEAVY
...
report = {"status": "FAIL_DIRECT", "variant": "M-3x4-7.0__R25_BOTTOM_HEAVY"}
...
try:
    ...
    # Save
    native = os.path.join(job_dir, "M-3x4-7.0__R25_BOTTOM_HEAVY.scdocx")
    step = os.path.join(job_dir, "M-3x4-7.0__R25_BOTTOM_HEAVY.step")
...
with open(os.path.join(job_dir, "M-3x4-7.0__R25_BOTTOM_HEAVY_report.json"), "w") as f:
